...
import { PipelineParams } from '../pipelines/migration-engine.pipeline.d.ts';
...
import {
  ...
  resultUtils,
  success,
} from '../shared-foundation/result-utilities';
...
export interface ReorganizationOptions {
  ...
  readonly businessImpactAnalysis: boolean;
...
export interface DomainMapping {
  ...
  readonly targetDomain: BusinessDomain;
  readonly targetPath: DirectoryPath;
 ...
 */
export interface ReorganizationMetrics {
...
export interface ReorganizationResult {
  ...
  readonly metrics: ReorganizationMetrics;
  readonly movements: readonly FileMovement[];
  readonly businessImpact: RiskAssessment;
